...
`domangcha/stack-selection-rubric.md` 루브릭 적용 → 조건별 점수 합산 → 최고점 추천:
```
[CEO STACK SELECTION]
매칭 조건: <번호. 조건명 → Std+N / Ral+N / Gs+N / SP+N 형식으로 나열>
┌────────────────────────────────────────────────────┐
│ [?] <1위>    │ <막대>  <점수>pt │ 이유: <조건 요약> │
│ [?] <2위>    │ <막대>  <점수>pt │                  │
│ [?] <3위>    │ <막대>  <점수>pt │                  │
│ [?] <4위>    │ <막대>  <점수>pt │                  │
└────────────────────────────────────────────────────┘
💡 추천: [N] <스택명> (Std N/Ral N/Gs N/SP N) — <이유> | 선택(1-4, Enter=추천):
```
